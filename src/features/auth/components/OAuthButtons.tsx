...
export function OAuthButtons({ onSuccess }: { onSuccess?: () => void }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Button variant="outline" type="button" onClick={() => handleLogin("google")}>
      ...
      <Button variant="outline" type="button" onClick={() => handleLogin("apple")}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
      ...
      <Button variant="outline" type="button" onClick={() => handleLogin("42")}>
        <svg
